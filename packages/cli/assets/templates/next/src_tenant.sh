...
cat << 'END_OF_FILE_CONTENT' > "package.json"
{
  ...
  "scripts": {
    ...
    "dist": "bash ./src2Code.sh --template next app src scripts middleware.ts next.config.ts postcss.config.mjs tsconfig.json package.json next-env.d.ts vitest.config.ts",
