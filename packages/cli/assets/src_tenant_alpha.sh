...
END_OF_FILE_CONTENT
mkdir -p "scripts/vite"
echo "Creating scripts/vite/tenantDevApiPlugin.ts..."
cat << 'END_OF_FILE_CONTENT' > "scripts/vite/tenantDevApiPlugin.ts"
/**
...
cat << 'END_OF_FILE_CONTENT' > "tsconfig.node.json"
{
  ...
  "include": ["vite.config.ts", "scripts/vite/**/*.ts"]
}
